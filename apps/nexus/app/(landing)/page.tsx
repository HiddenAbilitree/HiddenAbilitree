  ...
  <Section className="from-tns-blue/25 to-tns-blue/5 h-screen gap-4 bg-black bg-linear-to-b to-80%">
    <div className="2xs:text-8xl lg:text-10xl xl:text-10xl 3xl:text-11xl absolute bottom-24 left-8 flex flex-col text-7xl sm:text-8xl md:text-9xl">
      <h1 className="flex flex-col">
        <span className="text-tns-white/70 text-edge-cap text-trim-both uppercase">
          Eric
        </span>
        {` `}
      ...
      <div className="xs:ml-1.5 ml-1 text-base md:ml-2.5">
        <span className="text-tns-magenta">
          Masters Computer Science Student at GMU
        </span>
    ...
    <div className="absolute right-0 bottom-6 left-0 flex w-full items-center gap-8 px-8">
      ...
      <span className="text-tns-white/50 text-center text-nowrap select-none">
        Scroll Down
      </span>
      <Separator className="bg-tns-blue/10" />
    </div>
...
const Projects = () => (
  <Section
    className="from-tns-blue/5 to-tns-blue/5 bg-linear-to-b"
    id="projects"
  >
