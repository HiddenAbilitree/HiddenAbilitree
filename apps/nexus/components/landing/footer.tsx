...
export const Footer = () => (
  <section className='from-tns-blue/5 to-tns-blue/40 h-screen w-full bg-black bg-gradient-to-b md:p-4'>
    <footer className='bg-tns-white text-tns-black sm:pt-22 md:pt-18 flex size-full flex-col gap-2 p-4 pt-16 shadow-xl sm:p-6 md:rounded-3xl overflow-hidden'>
      <Separator className='bg-border/80' />
      <h1 className='3xl:text-11xl text-6xl leading-[0.8] sm:text-8xl md:text-8xl 2xl:text-9xl'>
        CONTACT ME
      </h1>
      <Separator className='bg-border/80' />
      <p className='mr-50 md:text-xl lg:text-2xl'>
        Colorscheme @{' '}
        <Link
