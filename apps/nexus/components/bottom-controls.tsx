...
export const BottomControls = () => {
  ...
  return (
    <>
      <div className='fixed right-4 bottom-4 z-50 flex flex-col items-end md:right-auto md:bottom-8 md:left-8 md:items-start'>
        <Chatbot isOpen={chatOpen} onCloseAction={() => setChatOpen(false)} />
        <div className='flex items-center gap-2 md:rounded-full md:border-2 md:border-tns-blue md:bg-tns-black md:p-3 md:shadow-lg'>
          <motion.button
            aria-label='Smooth Scroll'
            className='group hidden size-10 items-center justify-center overflow-clip rounded-full border-2 bg-tns-black p-2 shadow-md hover:cursor-pointer hover:bg-tns-black-hover md:flex'
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
          >
            <Robot className='z-50 size-16 fill-[#888888] group-hover:fill-tns-white' />
          </motion.button>
        </div>
      </div>
